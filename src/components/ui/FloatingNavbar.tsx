  ...
  return (
    ...
    icon?: JSX.Element;
          ...
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center flex space-x-1 text-white/80 dark:hover:text-neutral-300 hover:text-neutral-500"
            )}
          >
        ...
        <button className=" text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-blue-600 dark:text-white px-4 py-2 rounded-full">
